...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'rm:migrate-photos';
     ...
     * @var string
     */
    protected $description = 'Creates a migration for the photos package.';
     ...
     * @var string
     */
    protected $migrationSuffix = 'rental_manager_photos_setup_tables';
    ...
    {
        $this->laravel->view->addNamespace('photos', __DIR__.'/../../views');
        $this->line('');
        $this->info("Rental Manager Photos Migration Creation.");
        $this->line('');
    ...
    protected function createMigration()
    {
        ...
        $output = $this->laravel->view
            ->make('photos::migration')
            ->with(['photos' => Config::get('photos')])
            ->render();
    ...
    {
        $tables = Collection::make(Config::get('photos.tables'))->sort();
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Photos migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Photos migration already exists.\nFollowing file was found: ";
        }
